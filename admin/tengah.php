...
$host = $_SERVER['HTTP_HOST'];
                                 echo"<tbody>
                                     <tr>
                                         ...
                                         <td>$t[judul]</td>
                                         <td>";
                                            if ($t['status_url'] == 'belum') {
                                                echo " <button class='btn btn-info btn-sm' data-toggle='modal' data-target='#ui$t[id_berita]''>Buat qrcode</button>";
                                            } else {
                                                echo "<button class='btn btn-success btn-sm' data-toggle='modal' data-target='#cetak$t[id_berita]'><i class='fa fa-print'></i>print</button>";
                                            }
                                            echo "
                                        </td>
                                         <td><a href='index.php?aksi=editinformasi&id_berita=$t[id_berita]' class='btn btn-info btn-sm' >edit</a>
                                             <a class='btn btn-danger btn-sm' href='hapus.php?aksi=hapusartikel&id_b=$t[id_berita]&gbr=$t[gambar]' onclick=\"return confirm ('Apakah yakin ingin menghapus $t[judul] ?')\">hapus</a>
                                         </td>
                                     </tr>                                      
                                 </tbody>
                         

                                  <div class='modal fade' id='cetak$t[id_berita]'' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
                                            <h4 class='modal-title' id='H3'>QRCODE Data $t[id_berita]</h4>
                                        </div>
                                        <div class='modal-body'>
                                        <img src='../uploads/qrcode/$t[id_berita].png' width='321' alt='QR Code'>
                                        <button class='btn btn-info btn-sm' data-toggle='modal' data-target='#ui$t[id_berita]''>Buat qrcode</button>
                                    </div>
                                     </div>
                                      </div>
                                </div>
                                         <div class='modal fade' id='ui$t[id_berita]'' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
                                        ...
                                        <div class='modal-body'>
                                        <form id='form1' enctype='multipart/form-data' method='post' action='edit.php?aksi=proseseditqrcode&id_berita=$t[id_berita]'>
                                        <div class='form-group'>
                                    <label>url</label>
                                    <textarea  class='form-control' name='url'>$host/sampah/utama.php?aksi=detailberita&id_berita=$t[id_berita]</textarea></br>
                                        <div class='modal-footer'>
                                                                        <button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>
                                                                        <button type='submit' class='btn btn-primary'>Save </button>
                                                                    </div> </div>
...
<thead>
                 ...
                 ";
$no=0;                 
$tebaru=mysqli_query($koneksi," SELECT * FROM berita WHERE jenis='layanan' ORDER BY id_berita DESC ");
while ($t=mysqli_fetch_array($tebaru)){
$no++;  
                                 echo"<tbody>
                                     <tr>
                                         <td>$no</td>
                                         <td>$t[judul]</td>
                                         <td><a href='index.php?aksi=editlayanan&id_berita=$t[id_berita]' class='btn btn-info' >edit</a>
                                             <a class='btn btn-info' href='hapus.php?aksi=hapuslayanan&id_b=$t[id_berita]&gbr=$t[gambar]' onclick=\"return confirm ('Apakah yakin ingin menghapus $t[judul] ?')\">hapus</a>
                                         </td>
                                     </tr>                                      
                                 </tbody>
                        ...
                        <div class='modal fade' id='uiModal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        ...
                                        <div class='modal-body'>
                                        <form id='form1' enctype='multipart/form-data' method='post' action='input.php?aksi=inputlayanan'>
                                        <div class='form-group'>
                                    <label>Judul</label>
                                    <input type='text' class='form-control' name='jd'/><br>
                                    <label>Isi</label>
...
<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        ...
                        <div class='panel-body'>
                        <form id='form1' enctype='multipart/form-data' method='post' action='edit.php?aksi=proseseditlayanan&id_b=$t[id_berita]&gb=$t[gambar]'>
                        <div class='form-group'>
                    <label>Judul</label>
                    <input type='text' class='form-control' value='$t[judul]' name='jd'/><br>
                    <label>Isi</label>
